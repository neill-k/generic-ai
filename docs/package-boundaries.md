...
- Memory-consistency note: SDK-owned benchmark/report contracts may describe shared/private namespaces, consistency guarantees, operation envelopes, stale reads, conflicts, handoffs, projections, ACL decisions, and provenance gaps. Concrete memory synchronization and storage behavior remain plugin-owned.
