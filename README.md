...
`DEF-01` (identity/auth plugin boundary), `DEF-04` (runtime governance roadmap), `DEF-05` (TUI / web UI tracks), `DEF-06` (advanced observability beyond the OTEL baseline), and `DEF-07` (sandboxed execution research) landed as planning ADRs and roadmap docs.

### In flight

The remaining Epic 7 deferred tracks (`DEF-02` Postgres storage and `DEF-03` external queueing) are still in the backlog. Sandbox plugin P2 hardening follow-ups are tracked in `NEI-383`.
