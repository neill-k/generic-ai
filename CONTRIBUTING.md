...
5. Run the four-command quality gate to confirm the workspace still builds.
...
Before opening a pull request, the four-command quality gate must pass locally. That means:
